...
function UndoToasts({ recentlyHiddenQueue, onUndoHide }: UndoToastsProps) {
  if (recentlyHiddenQueue.length === 0) return null;
...
function InfiniteScrollSentinel({
  ...
  if (articles.length <= visibleCount) return null;
...
// Card grid, swipe hints, undo-hide toasts, and the infinite-scroll sentinel
// shown once there is at least one article to display.
  ...
  return (
    <div className="space-y-4">
      ...
      <ArticleCards
        ...
        onOpenInfo={onOpenInfo}
      />
      <UndoToasts recentlyHiddenQueue={recentlyHiddenQueue} onUndoHide={onUndoHide} />
